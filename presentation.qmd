...
ggplot(
  ...
  geom_smooth(formula = y ~ x, method = "loess", color = colors$beigeLight) +
  ggplot2::scale_color_gradient(low = colors$purpleDark, high = colors$greenLight) 
```
...
#| width: 700
#| fig-align: 'center'
knitr::include_graphics("VegVault_palette.png")
```
