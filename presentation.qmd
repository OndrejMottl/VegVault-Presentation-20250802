...
::: {.text-size-heading3 .text-bold}
3. [Standardisation]{.text-background-brownLight .text-color-white .text-bold} 
:::
...
- Fully reproducible workflows via GitHub and Zenodo (Modular, version-controlled pipelines with metadata)
